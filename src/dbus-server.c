...
static const gchar introspection_xml[] =
  ...
  "    <annotation name='com.mkps.powermanager.Annotation' value='AlsoOnInterface'/>"
  ...
  "        <annotation name='com.mkps.powermanager.Annotation' value='OnArg'/>"
  "      </arg>"
  "    </method>"
  "    <method name='GimmeStdout'/>"
  "    <signal name='VelocityChanged'>"
  "      <annotation name='com.mkps.powermanager.Annotation' value='Onsignal'/>"
                    ...
                    gpointer               user_data)
{
  ...
  else if (g_strcmp0 (method_name, "HelloWorld") == 0)
    {
